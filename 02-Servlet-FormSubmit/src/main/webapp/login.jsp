					...
					<div class="card">
						<div class="card-body">
							...
							<div class="my-3 bg-white rounded box-shadow">
								<h6 class="border-bottom border-gray pb-2 mb-0">If not register</h6>
								...
								<div class="media text-muted pt-3">
							          ...
							          <a href="index.jsp" class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">
							            <strong class="d-block text-gray-dark">click for register</strong>
							          </a>
						        </div>								
							</div>							
