						...
						<div class="card-body">
							<div>
								<h1 class="badge badge-primary" style="font-size: xx-large;">
									  Login Page <span class="badge" style="font-size: x-large; margin-left: 10px; background-color: rgb(233,84,140)">Doctor</span>				
								</h1>
							...
							<form method="POST" action="doctor_login" autocomplete="off">
								
								<div class="form-group">
									<label for="email">Enter Email</label>
									<input type="text" name="email" id="email" value="harishk@gmail.com" class="form-control">
								</div>
								<div class="form-group">
								...
								<div class="media text-muted pt-3 mb-0">
						          	...
						          	<p class="media-body mb-0 small lh-125 border-bottom border-gray">
					            		...
					            		<span style="display: flex; gap: 5px;">
						            		<a class="nav-link mb-0 pb-0" style="padding: 0;" href="user_login.jsp">User</a> - 
